...
$nim = $_GET['nim_mhs'];//mengambil nim dari addressbar
...
<form name="postform" action="update2_mhs.php" method="post">
	<fieldset>
		...
		<table>
			<input type="hidden" name="nik" value="<?php echo $mhs['nik']?>">
				<tr>
					...
					<td>
					<input type='text' name='nik' size='30' value="<?php echo $mhs['nik']?>" disabled="disabled">
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					...
					<td>
					<input type='text' name='tgl' size='30' value="<?php echo $mhs['tgl_lahir']?>">
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
					<textarea rows="4" cols="50" name="alamat" value="<?php echo $mhs['alamat']?>"><?php echo $mhs['alamat']?></textarea>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
					<input type='text' name='jabatan' size='30' value="<?php echo $mhs['jabatan']?>">
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
					<input type='text' name='pendidikan' size='30' value="<?php echo $mhs['jenjang_pendidikan']?>">
					</td>
				</tr>
				<tr>
				<tr>
