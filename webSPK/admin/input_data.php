...
<table border=0 cellspacing=0>
	...
	<td width="15%"bgcolor="maroon">
		<a href="input_data.html"><font color="white"> &nbsp;&nbsp;Input data</font></a></td> 
	<td width="15%"bgcolor="maroon">
				...
				<legend>Input Data Karyawan</legend>
					<table border=0>
						...
						<tr>
							...
							<td>
								<input type='text' name='tgl' size='30'> <I>YYYY-MM-DD</I>
							</td>
						</tr>
						<tr>
							<td>
						...
						<tr>
							...
							<td>
								<input type='text' name='jabatan' size='30'>
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								<input type='text' name='pendidikan' size='30'>
							</td>
						</tr>
						<tr>
							<td>
